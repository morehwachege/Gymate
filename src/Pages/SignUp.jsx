      ...
      <section className="login-section ">
        ...
        <section className="flex flex-row justify-center flex-wrap items-center gap-80 py-20">
          <section class="form text-xl">
            ...
            <h1 class="form__title text-[#007FFF]">Create an Account</h1>
            <p class="form__description font-medium text-xl">We'd love to welcome you to our community!</p>
            ...
            Already have an account?<br /> <Link to="/login">Log In</Link>
            </p>
          </section>
